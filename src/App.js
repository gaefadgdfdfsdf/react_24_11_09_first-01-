...
function App() {
  ...
  <div class="w-300px h-full border-r-slate-300 fixed left-0 top-0 border z-100">
    <svg class="w-250px mt-50">
    <path
    ...
    <ul class="ml-50"> 
      ...
      <li class="flex absolute mb-60px">
        <svg class="pr-4 w-10 h-10">
  ...
  <div class="absolute w-120 h-120 z-1 bg-slate-950">
      <div></div>

  </div>

  <div class="w-550px h-5000px mx-auto my-0 bg-black">
